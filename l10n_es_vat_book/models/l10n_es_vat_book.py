...
class L10nEsVatBook(models.Model):
    ...
    def _prepare_book_line_tax_vals(self, move_line, vat_book_line):
        _logger.info("---------------------Dentro de _prepare_book_line_tax_vals")
        _logger.info("el self es")
        _logger.info(self)
        _logger.info("que es vat_book_line")
        _logger.info(str(vat_book_line))
        _logger.info("la move_line que se tiene")
        _logger.info(move_line)
        _logger.info("veamos si tiene tax_ids")
        _logger.info(move_line.tax_ids)
        _logger.info("veamos si tiene tax_line_id")
        _logger.info(move_line.tax_line_id)
        balance = move_line.credit - move_line.debit
        _logger.info("el balance")
    ...
    def upsert_book_line_tax(self, move_line, vat_book_line, implied_taxes):
        _logger.info("---------------------Dentro de upsert_book_line_tax")
        _logger.info("el self es")
        _logger.info(self)
        _logger.info("que es move_line")
        _logger.info(move_line)
        _logger.info("tiene tax_line_id?")
        _logger.info(move_line.tax_line_id)
        _logger.info("tiene tax_ids?")
        _logger.info(move_line.tax_ids)
        _logger.info(str(vat_book_line))
        vals = self._prepare_book_line_tax_vals(move_line, vat_book_line)
        _logger.info("que vals me saca")
        _logger.info(vals)
